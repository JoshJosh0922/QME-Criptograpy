    ...
    switch (Operation) {
      case "+":
        for (let i = 0; i < minLength; i++) {
          Compute.push(datasA[i] + 2 * datasB[i]);
      ...
      case "*":
        ...
        if (formatNum !== 3) {
          for (let a = 0; a < 2; a++) {
            for (let b = 0; b < 2; b++) {
              Compute.push(
                Aset[a] * 2 * Bset[b * 2] + Aset[a + 2] * 2 * Bset[b * 2 + 1]
              );
          ...
          for (let a = 0; a < 3; a++) {
            for (let b = 0; b < 3; b++) {
              Compute.push(
                Aset[a] * 2 * Bset[b * 3] +
                  Aset[a + 3] * 2 * Bset[b * 3 + 1] +
                  Aset[a + 6] * 2 * Bset[b * 3 + 2]
              );
            }
          }
        }
        ...
        >
          <View style={styles.ContentContainer}>
            <View style={styles.HeaderContainer}>
              <Text style={styles.TitleText}>ScaleMultiply 2(B)</Text>
              {/* <Text style={styles.TitleText}>A) ? B</Text> */}
            </View>
                    ...
                    >
                      {formatNum === 2 ? (
                        Operation === "*" ? (
                          <>
                            <Text>
                              {AGetContent[0]} * {BNewContent[0]} {" + "}
                              {AGetContent[2]} * {BNewContent[1]}
                              {",  "}
                              {AGetContent[0]} * {BNewContent[2]} {" + "}
                              {AGetContent[2]} * {BNewContent[3]}
                            </Text>
                            <Text>
                              {AGetContent[1]} * {BNewContent[0]} {" + "}
                              {AGetContent[3]} * {BNewContent[1]}
                              {",  "}
                              {AGetContent[1]} * {BNewContent[2]} {" + "}
                              {AGetContent[3]} * {BNewContent[3]}
                            </Text>
                          </>
                        ) : (
                          <>
                            <Text>
                              {AGetContent[0]} {Operation} {BNewContent[0]}
                              {",  "}
                              {AGetContent[1]} {Operation} {BNewContent[1]}
                            </Text>
                            <Text>
                              {AGetContent[2]} {Operation} {BNewContent[2]}
                              {",  "}
                              {AGetContent[3]} {Operation} {BNewContent[3]}
                            </Text>
                          </>
                        )
                      ) : Operation === "*" ? (
                        <>
                          <Text>
                            ...
                            {AGetContent[3]} * {BNewContent[1]}
                            {" + "}
                            {AGetContent[6]} * {BNewContent[2]}
                            {",  "}
                            {AGetContent[0]} * {BNewContent[3]}
                            {" + "}
                            {AGetContent[3]} * {BNewContent[4]}
                            {" + "}
                            {AGetContent[6]} * {BNewContent[5]}
                            {",  "}
                            {AGetContent[0]} * {BNewContent[6]}
                            {" + "}
                            {AGetContent[3]} * {BNewContent[7]}
                            {" + "}
                            {AGetContent[6]} * {BNewContent[8]}
                          </Text>
                          <Text>
                            {AGetContent[1]} * {BNewContent[0]}
                            {" + "}
                            {AGetContent[4]} * {BNewContent[1]}
                            {" + "}
                            {AGetContent[7]} * {BNewContent[2]}
                            {",  "}
                            {AGetContent[1]} * {BNewContent[3]}
                            {" + "}
                            {AGetContent[4]} * {BNewContent[4]}
                            {" + "}
                            {AGetContent[7]} * {BNewContent[5]}
                            {",  "}
                            {AGetContent[1]} * {BNewContent[6]}
                            {" + "}
                            {AGetContent[4]} * {BNewContent[7]}
                            {" + "}
                            {AGetContent[7]} * {BNewContent[8]}
                          </Text>
                          <Text>
                            {AGetContent[2]} * {BNewContent[0]}
                            {" + "}
                            {AGetContent[5]} * {BNewContent[1]}
                            {" + "}
                            {AGetContent[8]} * {BNewContent[2]}
                            {",  "}
                            {AGetContent[2]} * {BNewContent[3]}
                            {" + "}
                            {AGetContent[5]} * {BNewContent[4]}
                            {" + "}
                            {AGetContent[8]} * {BNewContent[5]}
                            {",  "}
                            {AGetContent[2]} * {BNewContent[6]}
                            {" + "}
                            {AGetContent[5]} * {BNewContent[7]}
                            {" + "}
                            {AGetContent[8]} * {BNewContent[8]}
                          </Text>
                        </>
                      ) : (
                        <>
                          <Text>
                            {AGetContent[0]} {Operation} {BGetContent[0]}
                            {",  "}
                            {AGetContent[1]} {Operation} {BGetContent[1]}
                            {",  "}
                            {AGetContent[2]} {Operation} {BGetContent[2]}
                          </Text>
                          <Text>
                            {AGetContent[3]} {Operation} {BGetContent[3]}
                            {",  "}
                            {AGetContent[4]} {Operation} {BGetContent[4]}
                            {",  "}
                            {AGetContent[5]} {Operation} {BGetContent[5]}
                          </Text>
                          <Text>
                            {AGetContent[6]} {Operation} {BGetContent[6]}
                            {",  "}
                            {AGetContent[7]} {Operation} {BGetContent[7]}
                            {",  "}
                            {AGetContent[8]} {Operation} {BGetContent[8]}
                          </Text>
                        </>
                      )}
                    </View>
