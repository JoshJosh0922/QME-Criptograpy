    ...
    switch (Operation) {
      case "+":
        for (let i = 0; i < minLength; i++) {
          Compute.push(2 * datasA[i] + datasB[i]);
      ...
      case "*":
        ...
        if (formatNum !== 3) {
          for (let a = 0; a < 2; a++) {
            for (let b = 0; b < 2; b++) {
              Compute.push(
                2 * Aset[a] * Bset[b * 2] + 2 * Aset[a + 2] * Bset[b * 2 + 1]
              );
          ...
          for (let a = 0; a < 3; a++) {
            for (let b = 0; b < 3; b++) {
              Compute.push(
                2 * Aset[a] * Bset[b * 3] +
                  2 * Aset[a + 3] * Bset[b * 3 + 1] +
                  2 * Aset[a + 6] * Bset[b * 3 + 2]
              );
            }
          }
        }
        ...
        >
          <View style={styles.ContentContainer}>
            <View style={styles.HeaderContainer}>
              <Text style={styles.TitleText}>ScaleMultiply 2(A)</Text>
                    ...
                    >
                      {formatNum === 2 ? (
                        Operation === "*" ? (
                          <>
                            <Text>
                              {ANewContent[0]} * {BGetContent[0]} {" + "}
                              {ANewContent[2]} * {BGetContent[1]}
                              {",  "}
                              {ANewContent[0]} * {BGetContent[2]} {" + "}
                              {ANewContent[2]} * {BGetContent[3]}
                            </Text>
                            <Text>
                              {ANewContent[1]} * {BGetContent[0]} {" + "}
                              {ANewContent[3]} * {BGetContent[1]}
                              {",  "}
                              {ANewContent[1]} * {BGetContent[2]} {" + "}
                              {ANewContent[3]} * {BGetContent[3]}
                            </Text>
                          </>
                        ) : (
                          <>
                        ...
                        <>
                          <Text>
                            ...
                            {ANewContent[3]} * {BGetContent[1]}
                            {" + "}
                            {ANewContent[6]} * {BGetContent[2]}
                            {",  "}
                            {ANewContent[0]} * {BGetContent[3]}
                            {" + "}
                            {ANewContent[3]} * {BGetContent[4]}
                            {" + "}
                            {ANewContent[6]} * {BGetContent[5]}
                            {",  "}
                            {ANewContent[0]} * {BGetContent[6]}
                            {" + "}
                            {ANewContent[3]} * {BGetContent[7]}
                            {" + "}
                            {ANewContent[6]} * {BGetContent[8]}
                          </Text>
                          <Text>
                            {ANewContent[1]} * {BGetContent[0]}
                            {" + "}
                            {ANewContent[4]} * {BGetContent[1]}
                            {" + "}
                            {ANewContent[7]} * {BGetContent[2]}
                            {",  "}
                            {ANewContent[1]} * {BGetContent[3]}
                            {" + "}
                            {ANewContent[4]} * {BGetContent[4]}
                            {" + "}
                            {ANewContent[7]} * {BGetContent[5]}
                            {",  "}
                            {ANewContent[1]} * {BGetContent[6]}
                            {" + "}
                            {ANewContent[4]} * {BGetContent[7]}
                            {" + "}
                            {ANewContent[7]} * {BGetContent[8]}
                          </Text>
                          <Text>
                            {ANewContent[2]} * {BGetContent[0]}
                            {" + "}
                            {ANewContent[5]} * {BGetContent[1]}
                            {" + "}
                            {ANewContent[8]} * {BGetContent[2]}
                            {",  "}
                            {ANewContent[2]} * {BGetContent[3]}
                            {" + "}
                            {ANewContent[5]} * {BGetContent[4]}
                            {" + "}
                            {ANewContent[8]} * {BGetContent[5]}
                            {",  "}
                            {ANewContent[2]} * {BGetContent[6]}
                            {" + "}
                            {ANewContent[5]} * {BGetContent[7]}
                            {" + "}
                            {ANewContent[8]} * {BGetContent[8]}
                          </Text>
                        </>
                      ) : (
                        <>
